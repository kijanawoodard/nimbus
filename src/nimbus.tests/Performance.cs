...
/*
----------------------------------------
2013-10-19 02:31 | 10,000,000 iterations - Run full code
----------------------------------------
...
----------------------------------------
2013-10-19 02:48 | 10,000,000 iterations - Comment out Send
----------------------------------------
...
----------------------------------------
2013-10-19 02:48 | 10,000,000 iterations - Comment out all code in Execute
----------------------------------------
...
----------------------------------------
2013-10-19 02:49 | 10,000,000 iterations - Just call containsKey in Execute
----------------------------------------
...
----------------------------------------
2013-10-19 02:50 | 10,000,000 iterations - Just derefence subscription from dictionary
----------------------------------------
...
----------------------------------------
2013-10-19 02:51 | 10,000,000 iterations - ContainsKey _and_ dereference
----------------------------------------
...
----------------------------------------
2013-10-19 02:52 | 10,000,000 iterations - Just derefernce and create handlers
----------------------------------------
...
----------------------------------------
2013-10-19 02:53 | 10,000,000 iterations - Create handlers and result
----------------------------------------
...
----------------------------------------
2013-10-19 02:54 | 10,000,000 iterations - Create handlers, result, empty loop
----------------------------------------
...
----------------------------------------
2013-10-19 02:55 | 10,000,000 iterations - handle in the loop
----------------------------------------
...
----------------------------------------
2013-10-19 02:55 | 10,000,000 iterations - Call Dispatch in loop (still not doing containsKey)
----------------------------------------
...
----------------------------------------
2013-10-19 03:02 | 10,000,000 iterations - Full code
----------------------------------------
...
----------------------------------------
2013-10-19 03:01 | 10,000,000 iterations - TryGetValue instead of containsKey and dereference
----------------------------------------
...
----------------------------------------
2013-10-19 03:03 | 10,000,000 iterations - Just TryGetValue
----------------------------------------
...
----------------------------------------
2013-10-19 03:14 | 10,000,000 iterations - Use string for dictionary key instead of type - a bit slower
----------------------------------------
...
----------------------------------------
2013-10-19 03:16 | 10,000,000 iterations - use int for dictionary key - a bit faster
----------------------------------------
...
----------------------------------------
2013-10-19 03:30 | 10,000,000 iterations - Comment out Execute and call Dispatch(new Counter(), new DoIteration(), string.Empty);
----------------------------------------
Baseline: 0.0233921s | 427,494.75/ms
Manual: 0.3531677s | 28,315.16/ms
nimbus: 0.5983375s | 16,712.98/ms

----------------------------------------
2013-10-19 03:34 | 10,000,000 iterations - Putting counter in a an array and running loop
----------------------------------------
Baseline: 0.0235507s | 424,615.83/ms
Manual: 0.3419092s | 29,247.53/ms
nimbus: 0.6906271s | 14,479.59/ms
